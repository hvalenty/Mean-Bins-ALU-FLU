...
////////////////////////////////////////////////////////////////////////////////
 FILE *fp3 = fopen("FLU-Mean-Mid-PT-TFR.txt", "r");
int o = 0;
...
h3->GetYaxis()->SetRangeUser(-0.09, 0.0); //xF (-0.04, 0.04); Q2 (-0.05, 0.005); pT_TFR (-0.09, 0.0); pT_CFR (-0.02, 0.17)
...
c03->Print("FLU-Mean-Mid-PT-TFR.png");
