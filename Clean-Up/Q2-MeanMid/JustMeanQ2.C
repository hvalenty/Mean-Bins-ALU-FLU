...
TCut Mxg1 = ("Mx>1.35&&abs(vz_e-vz_p)<7&&abs(vz_e+3)<5");            // Cut applied to all cuts, change depending on parameters
...
float err3;
	...
	outputfile = fopen("Means-Xaxis-Q2.txt" , "wb");  // Text file to print to
