...
double ratio = x1/y1;
//FILE * fp1 = fopen("Depol-Mean-Mid-XF.txt", "r");

//FILE *fp2 = fopen("ALU-Mean-Mid-PT-TFR.txt", "r");
...
//fscanf(fp1, "%lf %lf %lf", &x1, &y1, &erry1); //no error calculated for pT depol (rm erry1 for Q2)
...
////////////////////////////////////////////////////////////////////////////////
 FILE *fp3 = fopen("FLU-Mean-Mid-PT-CFR.txt", "r");
int o = 0;
...
h3->GetYaxis()->SetTitle("Fracture Function"); // F_{LU} = A_{LU}/epsilon factor
...
h3->Draw("AP");
h3->GetXaxis()->SetRangeUser(0.0, 1.3);     //xF (-0.8, 0.6); Q2 (0.0, 6.0); pT (0.0, 1.3)
h3->GetYaxis()->SetRangeUser(-0.02, 0.17); //xF (-0.04, 0.04); Q2 (-0.05, 0.005); pT_TFR (-0.09, 0.0); pT_CFR (-0.02, 0.17)
...
c03->Print("FLU-Mean-Mid-PT-CFR.png");
